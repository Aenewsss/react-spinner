...
function Ut() {
  ...
  function pe(n, s, h) {
    ...
    if (n && n.defaultProps)
      for (C in T = n.defaultProps, T)
        _[C] === void 0 && (_[C] = T[C]);
    return { $$typeof: k, type: n, key: P, ref: j, props: _, _owner: q.current };
  }
  function Re(n, s) {
    return { $$typeof: k, type: n.type, key: s, ref: n.ref, props: n.props, _owner: n._owner };
  }
  function Ce(n) {
  ...
  function K(n, s, h, C, _) {
    ...
    if (j = 0, C = C === "" ? "." : C + ":", oe(n))
      ...
      for (n = w.call(n), T = 0; !(P = n.next()).done; )
        P = P.value, w = C + H(P, T++), j += K(P, s, h, w, _);
    else if (P === "object")
  ...
  return g.Children = { map: Y, forEach: function(n, s, h) {
    ...
    var C = se({}, n.props), _ = n.key, P = n.ref, j = n._owner;
    if (s != null) {
    ...
    return { $$typeof: k, type: n.type, key: _, ref: P, props: C, _owner: j };
    ...
    process.env.NODE_ENV !== "production" && function() {
      ...
      function _e(e, r, a, o, i) {
        ...
        if (l) {
          ...
          if (Fe(E)) {
            var A = "";
            O != null && (A = ve(O) + "/"), _e(E, r, A, "", function(Mt) {
              return Mt;
            });
          } else
        ...
        if (Fe(e))
          ...
          if (typeof Lr == "function") {
            ...
            for (var Lt = Lr.call(ot), ut, Nt = 0; !(ut = Lt.next()).done; )
              x = ut.value, I = z + Ae(x, Nt++), W += _e(x, r, a, I, i);
          } else if (p === "object") {
            var it = String(e);
...
function pt() {
  return ft || (ft = 1, function(k) {
    process.env.NODE_ENV === "production" ? k.exports = Ut() : k.exports = Bt();
  }(Vt)), yr;
}
/**
 * @license React
...
function zt() {
  if (lt)
    return He;
  lt = 1;
  var k = pt(), y = Symbol.for("react.element"), Ee = Symbol.for("react.fragment"), X = Object.prototype.hasOwnProperty, de = k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, re = { key: !0, ref: !0, __self: !0, __source: !0 };
  function te(Q, L, Z) {
...
function qt() {
  return dt || (dt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var ae = k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function F(t) {
      {
    ...
    function ze(t, u, c, f, R, S) {
      {
        ...
        if (!b) {
          ...
          B ? m += B : m += xe();
          var D;
          t === null ? D = "null" : Le(t) ? D = "array" : t !== void 0 && t.$$typeof === y ? (D = "<" + (H(t.type) || "Unknown") + " />", m = " Did you accidentally export a JSX literal instead of a component?") : D = typeof t, F("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", D, m);
        }
        var $ = Cr(t, u, c, R, S);
        if ($ == null)
          return $;
...
(function(k) {
  process.env.NODE_ENV === "production" ? k.exports = zt() : k.exports = qt();
})(Wt);
const Ht = () => /* @__PURE__ */ Nr.jsx("div", { className: "spin" });
export {
  Ht as default
};
